...
// 外观设置函数实现
void ClickableWidget::setBorderRadius(int radius)
{
    m_borderRadius = radius;
    update();
}

void ClickableWidget::setBorderWidth(int width)
{
    m_borderWidth = width;
    update();
}

void ClickableWidget::setNormalColor(const QColor &color)
{
    m_normalColor = color;
    update();
}

void ClickableWidget::setHoverColor(const QColor &color)
{
    m_hoverColor = color;
    update();
}

void ClickableWidget::setPressedColor(const QColor &color)
{
    m_pressedColor = color;
    update();
}

void ClickableWidget::setBackgroundColor(const QColor &color)
{
