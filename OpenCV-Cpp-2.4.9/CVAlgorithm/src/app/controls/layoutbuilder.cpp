...
ColumnWithMargin::ColumnWithMargin(std::initializer_list<LayoutItem> items, int margin) {
    subItems = qListFromStdList<LayoutItem>(items);
    onAdd = [margin](LayoutBuilder& builder) {
        auto v = new QVBoxLayout;
        v->setSpacing(0);
...
RowWithMargin::RowWithMargin(std::initializer_list<LayoutItem> items, int margin) {
    subItems = qListFromStdList<LayoutItem>(items);
    onAdd = [margin](LayoutBuilder& builder) {
        auto h = new QHBoxLayout;
        h->setSpacing(0);
