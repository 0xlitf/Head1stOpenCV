...
void generate_shape_model_dynamic(HObject ImageModel, HObject RegionROI,
	HObject ModelRegions, HObject *ModelRegionsOrigin, HTuple WindowHandle,
	HTuple ModelIDs, HTuple ModelWidthAll, HTuple ModelHeightAll,
	HTuple ModelGrays, HTuple Threshold, HTuple WdiffValue,
	HTuple IsDynamic, HTuple *ModelID, HTuple *ModelWidth,
	HTuple *ModelHeight, HTuple *ModelArea, HTuple *ModelGrayVal,
	HTuple *isTrained);

void search_shape_model_gray(HObject ImageNew, HObject RegionROI,
	HObject ModelRegionsOrigins, HObject *ObjRegions, HTuple WindowHandle,
	HTuple ModelIDs, HTuple ModelGrays, HTuple Threshold,
	HTuple WdiffValue, HTuple MinScore, HTuple MinDefectInnerRadian,
	HTuple *NewRow, HTuple *NewColumn, HTuple *NewWidth,
...
//void search_shape_model_gray(HObject ho_ImageNew, HObject ho_RegionROI, HObject *ho_ObjRegions,
//	HTuple hv_WindowHandle, HTuple hv_Threshold, HTuple *hv_NewRow, HTuple *hv_NewColumn,
//	HTuple *hv_NewWidth, HTuple *hv_NewArea, HTuple *hv_Result);