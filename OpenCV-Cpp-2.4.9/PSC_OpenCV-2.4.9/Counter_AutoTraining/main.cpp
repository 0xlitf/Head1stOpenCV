...
{	
	...
	string strProjectPath = "D:/test/TestDLL/TestDLL/1";
	//string strRoiPath = "D:/test/TestDLL/TestDLL/roi.xml";
	//string strProjectPath = "D:/work/FullInspectionMachine/GIT/CountingProductionLine_AllSys_IOGrap_250811/x64/CountingProduction_client_allDetect/debug/Project/Halcon_1/1";
	string strRoiPath = "D:/test/TestDLL/TestDLL/roi.xml";
	bool bok_1;
	bool bok_2;
	bool bok_3;
	ptr_partsTrainer->dynamicTrainModeClose();//切换手动训练
	ptr_partsTrainer->setHalonMode(true);
	//ptr_partsTrainer->setTrainTarget(1);
	ptr_partsTrainer->reset(strProjectPath, strRoiPath);
	bok_1 = ptr_partsTrainer->HPDetection_start(strProjectPath, strRoiPath);
	cvInputImage = cv::imread("D:/test/TestDLL/TestDLL/image/b.png");
	bok_3 = ptr_partsTrainer->training(&cvInputImage, &cvOutputImage);
	//bok_2 = ptr_partsTrainer->HPDetection_train(cvInputImage, cvOutputImage);
