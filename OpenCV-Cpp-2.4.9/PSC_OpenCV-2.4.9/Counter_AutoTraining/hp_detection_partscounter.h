...
private:
	...
	HTuple  hv_DLDatasetInfo, hv_MaxNumInferenceImages, hv_AnomalyInferenceImagePaths;
	...
	HTuple  hv_MetaData, hv_InferenceClassificationThreshold, hv_InferenceSegmentationThreshold;
